    ...
    public partial class MoviesContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySql("server=localhost;userid=root;pwd=rootpass;port=3306;database=Movies;sslmode=none;");
                //optionsBuilder.UseMySql("server=localhost;userid=root;pwd=rootpass;port=3306;database=MoviesTemp;sslmode=none;");
            }
        }
